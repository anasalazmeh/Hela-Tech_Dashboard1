...
import ContactUsContext from "../../context/contact-us/context";
import ContactUsContextProvider from "../../context/contact-us/provider";
...
const ContactUs = () => {
...

    {
      ...
      render: (_: any, record) => (
        <Space>
          <DeleteBtn
            onConfirm={async () => {
              await actions.deleteContactUs(record?.id);
            }}
  ...
  const { actions, list, loading } = useContext(ContactUsContext);
  ...
  return (
    <>
      <PageHeader
        title={"Contact us "}
        subTitle={"All registered contact us"}
        extra={[
          <Button
